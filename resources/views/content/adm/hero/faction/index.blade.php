            ...
            <form class="card" id="form" method="POST" action="{{ route('adm.hero.faction.store') }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group last:tw__mb-0">
                        <label>Icon</label>
                        <input type="file" class="form-control" id="input-icon" name="icon" accept=".jpg,.jpeg,.png,.svg,.gif">
                        <small class="text-muted tw__italic">*Max 200kb; Only accept .jpg, .jpeg, .png, .svg, .gif</small>
                    </div>
                    <div class="form-group last:tw__mb-0">
                        <label>Name</label>
