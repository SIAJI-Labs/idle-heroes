<form action="{{ route('s.game-mode.star-expedition.participation.store') }}" method="POST" class="modal fade" id="modal-participant" tabindex="-1" aria-labelledby="modal-participant" aria-hidden="true" style="display: none;">
    @csrf
    @method('POST')
