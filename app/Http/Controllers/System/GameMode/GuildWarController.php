...
class GuildWarController extends Controller
{
    ...
    {
        return view('content.system.game-mode.guild-war.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        // Check combination
        $checkCombination = \App\Models\GuildWar::where('period_id', $period->id)
    ...
    public function update(Request $request, $id)
    {
        ...
        $guild = $this->guildModel->where(\DB::raw('BINARY `uuid`'), $request->guild_id)
            ->firstOrFail();
        $data = $this->guildWarModel->where(\DB::raw('BINARY `uuid`'), $id)
            ->firstOrFail();
